...
Arabic translation of the NRC Hashtag Sentiment Lexicon
Version 0.1
30 September 2015
...
Arabic translation of NRC Hashtag Lexicon
-----------------------------------------
This lexicon was created by translating the terms in NRC Hashtag
Sentiment Lexicon into Arabic using Google Translate. The NRC Hashtag
Sentiment Lexicon is a list of English terms and their associations
with sentiment. The association is shown in the form of number
(sentiment score).  If the score for x1 is greater than the score for
x2, then x1 is considered more positive than x2. The Arabic
translation has 38,312 positive terms and 24,156 negative terms.
...
— English term: original English term in NRC Hashtag Lexicon.
— Arabic translation: Arabic translation of the English term, obtained using 
Google Translate. If the term has no translation, then the original English 
term is placed in this column.
— Sentiment Score: a score indicating the degree of association of the Arabic 
term with positive sentiment.
— Positive Occurrence Count: the number of times the English term co-occurs with 
positive seeds in the tweets corpus from which it is created.
— Negative Occurrence Count: the number of times the English term co-occurs with 
negative seeds in the tweets corpus from which it is created.
