...
is considered more positive than x2. The lexicon has 22,962 positive
terms and 20,342 negative terms.

The lexicon is extracted automatically from tweets that have certain
seed terms. The seeds used to create this lexicon are a set of 23
positive and negative emoticons such as :) and :(. For the purposes of
creating this lexicon, a tweet is considered positive if it has a
positive seed, and negative if it has a negative seed.
